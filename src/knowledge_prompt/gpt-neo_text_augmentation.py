...
def main():
    ...
    output_txt_jsonl = '/shared/nas/data/m1/wangz3/video_language_pretraining_project/ALPRO/src/knowledge_prompt/augmented_data/msrvtt_ret/gpt-neo_augmented_test.jsonl'
